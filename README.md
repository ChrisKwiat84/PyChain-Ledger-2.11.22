...
Streamlit interface created to develop blockchain-based ledger system. Dataclasses where created utilizing "Record", "Block", and "Pychain" to mimic a ledger. This ledger records each transaction and the previous hash then checks validity of the transaction history. 
